...
public class Controlador {
    ...
    public Controlador() throws I2CFactory.UnsupportedBusNumberException {
        ...
        pernas[PERNA_1].getBase().setLimites(300, 450);
        ...
        pernas[PERNA_2].getBase().setLimites(300, 450);
        ...
        pernas[PERNA_3].getBase().setLimites(300, 450);
        ...
        pernas[PERNA_4].getBase().setLimites(300, 450);
    }
