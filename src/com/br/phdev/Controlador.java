...
public class Controlador {
    ...
    public Controlador() throws I2CFactory.UnsupportedBusNumberException {
        ...
        pernas[PERNA_1] = new Perna(
                new Tarso(modulo, 0, 200), new Femur(modulo, 4, 425), new Base(modulo, 5, 375));
        ...
        pernas[PERNA_2] = new Perna(
                new Tarso(modulo, 1, 450), new Femur(modulo, 2, 325), new Base(modulo, 3, 375));
        ...
        pernas[PERNA_3] = new Perna(
                new Tarso(modulo, 14, 450), new Femur(modulo, 6, 325), new Base(modulo, 7, 375));
        ...
        pernas[PERNA_4] = new Perna(
                new Tarso(modulo, 15, 200), new Femur(modulo, 9, 425), new Base(modulo, 8, 375));
